...
<p class="polyglot_license">Polyglot_XH is free software: you can
redistribute it and/or modify it under the terms of the GNU General Public
License as published by the Free Software Foundation, either version 3 of the
License, or (at your option) any later version.</p>
<p class="polyglot_license">Polyglot_XH is distributed in the hope that it
...
<p class="polyglot_license">You should have received a copy of the GNU
General Public License along with Polyglot_XH. If not, see
